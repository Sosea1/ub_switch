...
import classes from './L3functions_Property1Default.module.css';
...
/* @figmaId 112:200 */
export const L3functions_Property1Default: FC<Props> = memo(function L3functions_Property1Default(props = {}) {

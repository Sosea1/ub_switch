...
import classes from './ProtocolVLAN.module.css';

interface Props {
  className?: string;
}
/* @figmaId 470:10697 */
export const ProtocolVLAN: FC<Props> = memo(function ProtocolVLAN(props = {}) {
  return (
    <div className={`${resets.storybrainResets} ${classes.root}`}>
      <div className={classes.emulatorTpLinkComByHtmlToDesig}>
        <PingButton_Property1Default
          ...
          text={{
            ping: <div className={classes.ping}>Protocol VLAN Group</div>,
          }}
        />
        <PingButton_Property1Default
          className={classes.pingButton2}
          text={{
            ping: <div className={classes.ping2}>Protocol Template</div>,
          }}
        />
      </div>
      <div className={classes.emulatorTpLinkComByHtmlToDesig2}>
        <div className={classes.divPanelHeader}>
          <div className={classes.heading3}>
            <div className={classes.protocolVLANGroupConfig}>Protocol VLAN Group Config</div>
          </div>
        </div>
                ...
                <div className={classes.frame25}>
                  <div className={classes.frame27}>
                    ...
                    <div className={classes.cell5}>
                      <div className={classes._8021qPriority}>802.1q Priority</div>
                    </div>

...
import classes from './MLDSnooping.module.css';
...
/* @figmaId 452:2256 */
export const MLDSnooping: FC<Props> = memo(function MLDSnooping(props = {}) {
  return (
    <div className={`${resets.storybrainResets} ${classes.root}`}>
      ...
      <div className={classes.divJumbo}>
        <div className={classes.divWidgetFieldlabelWrap}>
          <div className={classes.labelJumbo}>MLD Snooping:</div>
        </div>
            ...
            <div className={classes.frame252}>
              <div className={classes.frame272}>
                ...
                <div className={classes.cell11}>
                  <div className={classes.mLDSnoopingStatus}>MLD Snooping Status</div>
                </div>
                ...
                <div className={classes.cell14}>
                  <div className={classes.mLDSnoopingQuerier}>MLD Snooping Querier</div>
                </div>

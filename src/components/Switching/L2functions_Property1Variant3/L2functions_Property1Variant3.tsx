...
import classes from './L2functions_Property1Variant3.module.css';
...
/* @figmaId 112:305 */
export const L2functions_Property1Variant3: FC<Props> = memo(function L2functions_Property1Variant3(props = {}) {

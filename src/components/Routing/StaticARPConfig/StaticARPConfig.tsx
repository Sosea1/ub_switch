...
import classes from './StaticARPConfig.module.css';

interface Props {
  className?: string;
}
/* @figmaId 452:2433 */
export const StaticARPConfig: FC<Props> = memo(function StaticARPConfig(props = {}) {
  return (
    <div className={`${resets.storybrainResets} ${classes.root}`}>
      <div className={classes.emulatorTpLinkComByHtmlToDesig}>
        <div className={classes.divPanelHeader}>
          <div className={classes.heading3}>
            <div className={classes.staticARPConfig}>Static ARP Config</div>
          </div>
        </div>

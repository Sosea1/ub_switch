...
import classes from './IPv6Table.module.css';

interface Props {
  className?: string;
}
/* @figmaId 541:1010 */
export const IPv6Table: FC<Props> = memo(function IPv6Table(props = {}) {
  return (
    <div className={`${resets.storybrainResets} ${classes.root}`}>
      <div className={classes.frame16}>
        ...
        <div className={classes.iPv6RoutingTable}>IPv6 Routing Table</div>

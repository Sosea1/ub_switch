...
import classes from './Monitoring_Property1Variant3.module.css';
...
/* @figmaId 112:379 */
export const Monitoring_Property1Variant3: FC<Props> = memo(function Monitoring_Property1Variant3(props = {}) {

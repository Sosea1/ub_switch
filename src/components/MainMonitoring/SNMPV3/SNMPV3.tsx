...
import classes from './SNMPV3.module.css';
...
/* @figmaId 421:1481 */
export const SNMPV3: FC<Props> = memo(function SNMPV3(props = {}) {
  return (
    <div className={`${resets.storybrainResets} ${classes.root}`}>
      <div className={classes.link}>
        <div style={{cursor: 'pointer'}} className={classes.sNMPGroup}>SNMP Group</div>
      </div>
      <div className={classes.link2}>
        <div style={{cursor: 'pointer'}} className={classes.sNMPUser}>SNMP User</div>
      </div>

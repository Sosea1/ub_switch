...
import classes from './SflowCollector.module.css';

interface Props {
  className?: string;
}
/* @figmaId 421:1742 */
export const SflowCollector: FC<Props> = memo(function SflowCollector(props = {}) {
  return (
        ...
        <div className={classes.divH2dE0a38746}>
          <div className={classes.divPanelWrap}>
            <div className={classes.divPanelHeader}>
              <div className={classes.heading3}>
                <div className={classes.collectorConfig}>Collector Config</div>
              </div>
            </div>
              ...
              <div className={classes.divScrollXContainer}>
                <div className={classes.divContainer}>
                  ...
                  <div className={classes.cell4}>
                    <div className={classes.collectorIP}>Collector IP</div>
                  </div>
                  <div className={classes.cell5}>
                    <div className={classes.collectorPort}>Collector Port</div>
                  </div>
                  <div className={classes.cell6}>
                    <div className={classes.maximumDatagramSize}>Maximum Datagram Size</div>
                  </div>
                  <div className={classes.cell7}>
                    <div className={classes.timeoutS}>Timeout (s)</div>
                  </div>
                  <div className={classes.cell8}>
                    <div className={classes.lifetimeS}>Lifetime (s)</div>
                  </div>
                </div>
                  ...
                  <div className={classes.row}>
                    ...
                    <div className={classes.data4}>
                      <div className={classes.divContent3}>
                        <div className={classes._6343}>6343</div>
                      </div>
                    </div>
                  ...
                  <div className={classes.row2}>
                    ...
                    <div className={classes.data10}>
                      <div className={classes.divContent8}>
                        <div className={classes.unnamed4}>0.0.0.0</div>
                      </div>
                    </div>
                    <div className={classes.data11}>
                      <div className={classes.divContent9}>
                        <div className={classes._63432}>6343</div>
                      </div>
                    </div>
                  ...
                  <div className={classes.row3}>
                    ...
                    <div className={classes.data17}>
                      <div className={classes.divContent14}>
                        <div className={classes.unnamed7}>0.0.0.0</div>
                      </div>
                    </div>
                    <div className={classes.data18}>
                      <div className={classes.divContent15}>
                        <div className={classes._63433}>6343</div>
                      </div>
                    </div>
                  ...
                  <div className={classes.row4}>
                    ...
                    <div className={classes.data24}>
                      <div className={classes.divContent20}>
                        <div className={classes.unnamed10}>0.0.0.0</div>
                      </div>
                    </div>
                    <div className={classes.data25}>
                      <div className={classes.divContent21}>
                        <div className={classes._63434}>6343</div>
                      </div>
                    </div>
          ...
          <div className={classes.divSflowCollectorNotes}>
            ...
            <div className={classes.item}>
              <div className={classes.aTimeoutValueOfIndicatesThatTh}>

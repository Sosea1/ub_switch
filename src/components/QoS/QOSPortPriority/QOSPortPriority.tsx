...
import classes from './QOSPortPriority.module.css';

interface Props {
  className?: string;
}
/* @figmaId 490:13131 */
export const QOSPortPriority: FC<Props> = memo(function QOSPortPriority(props = {}) {
  return (
        ...
        <div className={classes.divPanelWrap2}>
          <div className={classes.divPanelHeader}>
            <div className={classes.heading3}>
              <div className={classes.portPriorityConfig}>Port Priority Config</div>
            </div>
          </div>
                            ...
                            <div className={classes.bodyRow}>
                              <div className={classes.frame32}>
                                ...
                                <div className={classes.cell3}>
                                  <div className={classes.trustMode}>Trust Mode</div>
                                </div>
                        ...
                        <div className={classes.bodyRow2}>
                          <div className={classes.frame322}>
                            ...
                            <div className={classes.cell7}>
                              <div className={classes.untrusted}>Untrusted</div>
                            </div>

...
import classes from './RADIUSConfig.module.css';

interface Props {
  className?: string;
}
/* @figmaId 615:1418 */
export const RADIUSConfig: FC<Props> = memo(function RADIUSConfig(props = {}) {
  return (
      ...
      <div className={classes.serverGroup2}>
        <div className={classes.frame162}>
          ...
          <div className={classes.frame212}>
            ...
            <div className={classes.authenticationPort}>Authentication Port</div>
            <div className={classes.accountingPort}>Accounting Port</div>
            <div className={classes.retransmit}>Retransmit</div>
            <div className={classes.timeout}>Timeout</div>
            <div className={classes.nASIdentifier}>NAS Identifier</div>
